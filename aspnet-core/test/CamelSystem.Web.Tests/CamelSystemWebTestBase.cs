...
{
    public abstract class CamelSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CamelSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CamelSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CamelSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CamelSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CamelSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CamelSystemDbContext, Task<T>> func)
        {
            T result;
