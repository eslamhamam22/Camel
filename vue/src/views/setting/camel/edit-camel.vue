...
<script lang="ts">
    ...
    @Component
    export default class EditCamel extends AbpBase{
        ...
        async visibleChange(value:boolean){
            ...
            if(!value){
                ...
                //this.camel = Util.extend(true,{},this.$store.state.camel.editCamel);
                this.camel = await this.$store.dispatch({
                        type:'camel/get',
                        id:this.$store.state.camel.editCamel.id
                    });
       ...
       async calcCausalFunctions() {
            ...
            if (this.camel.causal.rightFrontFootSupportTime && this.camel.causal.leftFrontFootSupportTime && 
            this.camel.causal.rightFootSupportTime && this.camel.causal.leftFootSupportTime) {
